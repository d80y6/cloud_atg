...
<!-- ====================================================== -->
                ...
                <!-- <div class="x_panel">
                  <div class="x_title">
                    <h2>Pumps <small>Manage Pumps Here</small></h2>
                    <ul class="nav navbar-right  pull-right">
					<li class="pull-right" id="addnew"><a style="padding:5px; " class="text-primary" href="#" onclick="addNew()"><i class="fa fa-plus-circle"></i> Add New Pump</a></li>
						<li class="pull-right "><a style="padding:5px;" class="text-warning" href="#" onclick="loadPumptable()"><i class="fa fa-refresh"></i> Refresh</a></li>
                  ...
                  <div class="x_content">
                    <table id="tblpumps" class="table table-hover">
						<thead> 
								<tr>
								<th>Pump Name </th>
								<th>Product</th>
...
<?php    $this->load->view('general/scriptPumpmgt') ; ?>
