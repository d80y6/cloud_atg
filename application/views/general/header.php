        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="general" class="site_title"><i class="fa fa-database"></i> <span>WHITE</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
				...
				<li><a href="<?php echo base_url() ; ?>index.php/companymgt"><i class="fa fa-building-o"></i> My Companies </a></li>
				...
				<li><a href="<?php echo base_url() ; ?>index.php/backup"><i class="fa fa-cloud-upload"></i> Backup</a></li>
