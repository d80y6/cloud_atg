...
<!-- dummy test page yo -->
  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <table id="tblcompanies" class="table table-hover">
						<thead> 
								<tr>
...
<div class="modal" id="myModal">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
	  ...
	  <b style="font-size:150%"  class="modal-title">View/Edit Company</b>
                ...
                <form method="POST">
					...
					<div class="row">
						...
						<div class="form-group col-md-6 col-sm-6 col-xs-12">
							...
							<input id="cpnum" type="number" placeholder="Phone Number (11 Digits)" class="form-control" name="cpnum">
			...
			<div class="modal-body">
                ...
                <form method="POST">
					...
					<div class="row">
						...
						<div class="form-group col-md-6 col-sm-6 col-xs-12">
							<!-- <label for="cpnum">Phone Number</label> -->
							<input id="acpnum" type="number" placeholder="Phone Number (11 Digits)" class="form-control" name="acpnum">
