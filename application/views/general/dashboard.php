...
<div class="page-header">
			...
			<div class="row" style="">
						...
						<div class="col-md-1 col-sm-4 col-xs-6 ">
						 ...
						 <div class="col-md-2 col-sm-4 col-xs-6 ">
						 <select id="stations" class="" style="width: 100%;margin-bottom:10px">
						 ...
						 <div class="col-md-2 col-sm-4 col-xs-6 ">
						 <select id="locations" class="" style="width: 100%;margin-bottom:10px">
						 ...
						 <div class="col-md-2 col-sm-4 col-xs-6 ">
						 <select id="companies" class="" style="width: 100%;margin-bottom:10px">
			...
			<div class="row">
              <div class="col-md-3 stretch-card grid-margin ">
                <div class="card bg-gradient-danger card-img-holder text-white sasas">
                  <div class="card-body">
                    ...
                    <h4 class="font-weight-normal mb-3">Companies <i class="mdi mdi-city mdi-24px float-right"></i>
                    </h4>
                    <h1 class="mb-5" id="coyCount">0000</h1>
                    <h6 class="card-text"><i class="red" id="iCoyCount">00 Inactive </i> | <a href="<?php echo base_url() ; ?>index.php/companymgt" class="">Manage </a></h6>
                  </div>
                </div>
              </div>
              <div class="col-md-3 stretch-card grid-margin ">
                <div class="card bg-gradient-primary card-img-holder text-white sasas">
                  <div class="card-body">
                    <img src="<?php echo base_url() ; ?>asset/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
                    <h4 class="font-weight-normal mb-3">Stations <i class="mdi mdi-engine mdi-24px float-right"></i>
                    </h4>
                    <h1 class="mb-5" id="statCount">0000</h1>
                    <h6 class="card-text"><i class="red" id="iStatCount">00 Inactive </i> | <a href="<?php echo base_url() ; ?>index.php/stationmgt" class="">Manage </a></h6>
                  </div>
                </div>
              </div>
              <div class="col-md-3 stretch-card grid-margin">
              ...
              <!-- <div class="col-md-3 stretch-card grid-margin">
                <div class="card bg-gradient-warning card-img-holder text-white sasas">
                  <div class="card-body">
                    <img src="<?php echo base_url() ; ?>asset/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
                    <h4 class="font-weight-normal mb-3">Devices <i class="mdi mdi-desktop-mac mdi-24px float-right"></i>
                    </h4>
                    <h1 class="mb-5" id="devCount" >0000</h1>
 ...
 <div class="row"> -->
 	...
 	<div class="col-md-6 grid-margin stretch-card">
		<div class="card">
			<div class="card-body">
				<div class="clearfix">
					<h4 class="card-title float-left" style="border-bottom: solid 1px #f3eded">Top 5 Stations Due For Reorder </h4>

					<!-- <div id="visit-sale-chart-legend" class="rounded-legend legend-horizontal legend-top-right float-right"></div> -->
				</div>
	
		<!-- <div id="srf" style="display:inline">
	...
	<div class="col-md-6 grid-margin stretch-card">
		<div class="card">
			<div class="card-body">
				<div class="clearfix">
					<h4 class="card-title float-left" style="border-bottom: solid 1px #f3eded" >Pending Approvals </h4>
					<!-- <div id="visit-sale-chart-legend" class="rounded-legend legend-horizontal legend-top-right float-right"></div> -->
				</div>
	...
	<!-- <div class="col-md-4 grid-margin stretch-card">
		<div class="card">
			<div class="card-body">
				<div class="clearfix">
					<h4 class="card-title float-left" style="border-bottom: solid 1px #f3eded" >Most Active Users </h4>
				</div>
	...
	<div class="col-md-6 grid-margin stretch-card">
		<div class="card">
			<div class="card-body">
				<div class="clearfix">
					<h4 class="card-title float-left" style="border-bottom: solid 1px #f3eded" >Faulty/Inactive Devices </h4>
					<!-- <div id="visit-sale-chart-legend" class="rounded-legend legend-horizontal legend-top-right float-right"></div> -->
				</div>
