				...
				<div class="card-body">
								...
								<div class="" role="tabpanel" data-example-id="togglable-tabs">
									<ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
										<li role="presentation" id="t1" class="active"><a href="#tab_content1" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true">Recent Pump Data</a>
										</li>
...
<?php    $this->load->view('station/scriptPumpmgt') ; ?>
