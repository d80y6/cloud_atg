...
<div class="page-header">
 ...
 <div class="col-md-8 grid-margin stretch-card">
		<div class="card">
			<div class="card-body">
				<div class="clearfix">
					<h4 class="card-title float-left" style="border-bottom: solid 1px #f3eded" > Volume Sales by Product <small class="text-danger">(In The Last Month)</small> </h4>
				</div>
 ...
 <div class="col-md-4 grid-margin stretch-card">
		<div class="card">
			<div class="card-body" style="padding-left: 1rem;">
				<div class="clearfix">
					<h4 class="card-title float-left" style="border-bottom: solid 1px #f3eded" >PMS <small class="text-danger">(In The Last Month)</small> </h4>
				</div>
		...
		<col width="33%"> -->
			<thead>
				...
				<th>Stations</th>
					<th >Avg Days <br> to <br>Reorder</th>
	...
	<div class="col-md-4 grid-margin stretch-card">
		<div class="card">
			<div class="card-body" style="padding-left: 1rem;">
				<div class="clearfix">
					<h4 class="card-title float-left" style="border-bottom: solid 1px #f3eded" >AGO <small class="text-danger">(In The Last Month)</small></h4>
				</div>
	...
	<div class="col-md-4 grid-margin stretch-card">
		<div class="card">
			<div class="card-body" style="padding-left: 1rem;">
				<div class="clearfix">
					<h4 class="card-title float-left" style="border-bottom: solid 1px #f3eded" >DPK <small class="text-danger">(In The Last Month)</small> </h4>
				</div>
