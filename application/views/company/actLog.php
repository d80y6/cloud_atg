  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
					...
					<!-- <li class="pull-right "><a style="padding:5px; background-color:#ededed" class="text-warning " href="#" onclick="loadAlogtable()"><i class="fa fa-refresh"></i> Refresh</a> </li>-->
...
<?php    $this->load->view('company/scriptActLogs') ; ?>
