    ...
    <div class="container-scroller">
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <a class="navbar-brand brand-logo" href="<?php echo base_url() ; ?>index.php/company"><i class="mdi mdi-bulldozer text-primary"></i> <font class="text-primary">ATG</font> </a>
          <a class="navbar-brand brand-logo-mini" href="<?php echo base_url() ; ?>index.php/company"><i style="margin-left:10px" class="mdi mdi-bulldozer text-primary"></i> <font class="text-primary">ATG</font> </a>
        </div>
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="<?php echo base_url() ; ?>index.php/company">
